...
def convert_build(args):
    ...
    args.load_model = './saved_model_ComplexLeNet/model_ComplexLeNet_small'
    model = load_model(args.load_model + '.h5', custom_objects=co)
    args.output_dir = './hls_model_ComplexLeNet_dropout_Virtex_small'
    # sys.exit()
    ...
    cfg['XilinxPart'] = 'xc7vx485tffg1761-2'
    cfg['Part'] = 'xc7vx485tffg1761-2'
    cfg['Bayes'] = True
    cfg['ClockPeriod'] = 10
