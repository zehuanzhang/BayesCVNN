...
def convert_build(args):
    ...
    args.load_model = './saved_model_ComplexLeNet/model_ComplexLeNet_1layer_B'
    model = load_model(args.load_model + '.h5', custom_objects=co)
    args.output_dir = './hls_model_ComplexLeNet_dropout_1layer/hls_model_ComplexLeNet_dropout_1layer_B'
    # sys.exit()
