...
class LeNet_P_complex(LeNet):
    def __init__(self, input_size, output_size, args):
        super(LeNet_P_complex, self).__init__(input_size, output_size, args)
        ...
        self.layers = nn.ModuleList(
            [ComplexConv2d(in_channels=self.init_channels, out_channels=20, kernel_size=5, padding=2, bias=False),
             ...
             ComplexReLU(),
             ComplexLinear(in_features=500, out_features=output_size, bias=False)])
