...
parser.add_argument('--model', type=str, default='vgg_half_complex',
...
parser.add_argument('--gpu', type=int, default=0, help='gpu device ids')  #0:4

parser.add_argument('--q', action='store_true',
                    help='whether to do post training quantisation')

parser.add_argument('--config_complex', default='[1,1,1,2,3]',
                    help='config_complex')


def main():
  args = parser.parse_args()
  print(args.config_complex)
  load = False
  if args.save != 'EXP':
    load = True
  ...
  if not load:
    args.config_complex = eval(args.config_complex)
